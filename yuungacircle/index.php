                ...
                <article>
                    <div id="pageTitle">
                        <div id="pageTitleIcon">
                            <i class="fa fa-random" id="locIcon"></i>
                        </div>
                        <div id="title">
                            <h1 id="Tit">Yuunga Circle</h1>
                        </div>
                    </div>
                </article>
                <article>
            ...
            <article class="CentreSection">
                <section class="mono-mainSec">
                    <article class="monoSec1">
                        ...
                        <div class="tabs">
                            <ul class="tab-links">
                                <li class="active"><a href="#tab1">Your Circle</a></li>
                                <li><a href="#tab2">Deliverables</a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <?php
                                    require_once (dirname(__FILE__).'/yourcircle.php');
                                ?>
                                </div>
                                <div id="tab2" class="tab">
                                <?php
                                    require_once (dirname(__FILE__).'/deliverables.php');
                                ?>
                                </div>
