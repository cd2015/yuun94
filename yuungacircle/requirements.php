...
?>
				...
				<form class="yungaForms" id="add_requirement" name="add_requirement" method="post" enctype="multipart/form-data" action="add_requirement.php">
					<h4>What you Require</h4>        
					
			<?php 
					
				$sql = "select * from circle where usrId = $user_id AND relType = 1";
			...
			?>
					<div>
							...
							<a class="update" href="delete_requirement.php?id=<?php echo $result['relId']; ?>">Delete</a>
