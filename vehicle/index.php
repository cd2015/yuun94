                ...
                <article>
                    <div id="pageTitle">
                        <div id="pageTitleIcon">
                            <i class="fa fa-bus" id="locIcon"></i>
                        </div>
                        <div id="title">
                            <h1 id="Tit">Vehicle</h1>
                        </div>
                    </div>
                </article>
            </div>
            ...
            <article class="CentreSection">
                <section class="mono-mainSec">
                    <article class="monoSec1">
                        <div class="tabs">
                            <ul class="tab-links">
                                <li class="active"><a href="#tab1">Garages</a></li>
                                <li><a href="#tab2">Batteries & Spare Parts</a></li>
                                <li><a href="#tab3">Tyres & Wheel Alignment</a></li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab2" class="tab">
                                    <div>
                                        <h2>Batteries & Spare Parts</h2>
                                        <?php require_once './Batteries&SpareParts.php'; ?>
                                    </div>                                                                                   
                                </div>
                                ...
                                <div id="tab3" class="tab">
                                    <div>
                                        ...
                                        <?php require_once './Tyres&WheelAlignment.php'; ?>
                                    </div>                                                                                   
                                </div>
