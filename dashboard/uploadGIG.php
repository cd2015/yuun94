...
<!--[if gt IE 8]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Yuunga | Upload GIG Photo </title>
    ...
    <body>
            <?php
                if ((login_check($mysqli) || ($_SESSION['FBID'])) == true) :
            ?>
                ...
                <section class="mono-mainSec">
                    <article class="monoSec1">
		                <div id="upload-wrapper">
                            <div align="center">
                               <h4>Upload a photo for your GIG (Step 2):</h4>&nbsp;
                                <span class="">Use only Jpeg, Jpg, Png or Gif images. | Maximum allowed size 1 MB</span>
                                <form style="width:30%" action="processuploadGIG.php" onSubmit="return false" method="post" enctype="multipart/form-data" id="MyUploadForm">
