        ...
        <section class="pageHeading">
            <div class="container">
                <article>
                    <div id="pageTitle">
                        <div id="title">
                            <h1 id="Tit">Upload Event Photo/Logo</h1>
                        </div>
                    </div>
                </article>
                ...
                <section class="mono-mainSec">
                    <article class="monoSec1">
                        <div id="upload-wrapper">
                            <div align="center">
                                <h4>Upload event's logo or photo (Step 2):</h4>&nbsp;
                                <span class="">Use only Jpeg, Jpg, Png or Gif images. | Maximum allowed size 4 MB</span>
                                <form style="width:30%" action="processupload.php" onSubmit="return false" method="post" enctype="multipart/form-data" id="MyUploadForm">
                            ...
                            <article>
                                <a style="float: right;padding-right: 50%;" href="./view_event.php">
                                    <p style="color: #662046; font-weight:bold; font-size:20px">FINISH</p>
                                </a>
                            </article>
                        </div>
                    </article>
