...
<!--[if gt IE 8]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Yuunga | Sanitary Experts </title>
            ...
            <article class="CentreSection">
                <section class="mono-mainSec">
                    <article class="monoSec1">
                        <div class="tabs">
                            <ul class="tab-links">
                                <li class="active"><a href="#tab1">Excavators</a></li>
                                <li><a href="#tab2">Fumigators</a></li>
                                <li><a href="#tab3">Sewer Trucks</a></li>
