...
//$event_create_2 = $event_day->format('U');
//Calculate 30 days
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ...
                <li class="bizDetail" id='events<?php echo $counter; ?>' style="display:none">
                    ...
                    <div class="resplacePhone">
                        <h6 class="DetTel">Date of Event: <span><?php echo $result ['event_date']; ?></span></h6>
                    </div>
                    <div class="resplacePhone">
                        <h6 class="DetMob">Time of Event: <span><?php echo $result ['event_start']; ?></span></h6>
                    </div>
