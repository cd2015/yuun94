<?php
    ...
    $sql = "SELECT * from add_business WHERE category='Garden/Interior Designs' AND region = 'Kampala'";
    $query = mysqli_query($conn, $sql);

    if (!$query->num_rows){

                echo '<p>','No Gardens/Interior Designs Firms!','</p>';
...
<ul class="area" id="Ebb">
    <h4 class="areaName">Entebbe</h4>
        <?php
            //Query that requests for all categories from ther table
            $sql = "SELECT * from add_business WHERE category='Gardens/Interior Designs' AND region = 'Entebbe'";
            $query = mysqli_query($conn, $sql);
...
<ul class="area" id="mbra">
   <h4 class="areaName">Mbarara</h4>
       <?php
           //Query that requests for all categories from ther table
           $sql = "SELECT * from add_business WHERE category='Gardens/Interior Designs' AND region = 'Mbarara'";
           $query = mysqli_query($conn, $sql);
...
<ul class="area" id="jinja">
    <h4 class="areaName">Jinja</h4>
        <?php
            //Query that requests for all categories from ther table
            $sql = "SELECT * from add_business WHERE category='Gardens/Interior Designs' AND region = 'Jinja'";
            $query = mysqli_query($conn, $sql);
...
<ul class="area" id="fort">
    <h4 class="areaName">Fort Portal</h4>
        <?php
            //Query that requests for all categories from ther table
            $sql = "SELECT * from add_business WHERE category='Gardens/Interior Designs' AND region = 'fort portal'";
            $query = mysqli_query($conn, $sql);
...
<ul class="area" id="mbale">
    <h4 class="areaName">Mbale</h4>
        <?php
            //Query that requests for all categories from ther table
            $sql = "SELECT * from add_business WHERE category='Gardens/Interior Designs' AND region = 'mbale'";
            $query = mysqli_query($conn, $sql);
...
<ul class="area" id="others">
    <h4 class="areaName">Gulu</h4>
        <?php
            //Query that requests for all categories from ther table
            $sql = "SELECT * from add_business WHERE category='Gardens/Interior Designs' AND region = 'Gulu'";
            $query = mysqli_query($conn, $sql);
...
<ul class="area" id="others">
    <h4 class="areaName">Rest of Uganda</h4>
        <?php
            //Query that requests for all categories from ther table
            $sql = "SELECT * from add_business WHERE category='Gardens/Interior Designs' AND region = 'others'";
            $query = mysqli_query($conn, $sql);
