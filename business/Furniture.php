...
$sql = "SELECT * from add_business WHERE category='Furniture' AND region = 'Kampala'";
$query = mysqli_query($conn, $sql);

if (!$query->num_rows) {

    echo '<p>', 'No Furniture Shops!', '</p>';
} else {
...
<ul class="area" id="Ebb">
    ...
    <?php
    //Query that requests for all categories from ther table
    $sql = "SELECT * from add_business WHERE category='Furniture' AND region = 'Entebbe'";
    $query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Furniture' AND region = 'Mbarara'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Furniture' AND region = 'Jinja'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Furniture' AND region = 'fort portal'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Furniture' AND region = 'mbale'";
$query = mysqli_query($conn, $sql);
...
<ul class="area" id="others">
    ...
    <?php
    //Query that requests for all categories from ther table
    $sql = "SELECT * from add_business WHERE category='Furniture' AND region = 'Gulu'";
    $query = mysqli_query($conn, $sql);
...
<ul class="area" id="others">
    ...
    <?php
    //Query that requests for all categories from ther table
    $sql = "SELECT * from add_business WHERE category='Furniture' AND region = 'others'";
    $query = mysqli_query($conn, $sql);
