...
$sql = "SELECT * from add_business WHERE category='Apartments' AND region='Kampala'";
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ...
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#ApartmentsKla<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                ...
                <li class="bizDetail" id='ApartmentsKla<?php echo $counter; ?>' style="display:none">
                    ...
                    <div id="days2go">
                         <a style="color:#fff" class="update" href="../browse/index.php?id=<?php echo $result['id']; ?>&name=<?php echo $result['business_name']; ?>">View Full Page for Gallery & Directions</a>
                    </div>
                    <div class="thumbImg">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Apartments' AND region='Entebbe'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area" id="Ebb">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#ApartmentsEbb<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='ApartmentsEbb<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Apartments' AND region='Fort Portal'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#ApartmentsFort<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='ApartmentsFort<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Apartments' AND region='Jinja'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#ApartmentsJinja<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                ...
                <li class="bizDetail" id='ApartmentsJinja<?php echo $counter; ?>' style="display:none">
...
<?php
$sql = "SELECT * from add_business WHERE category='A' AND region='Mbale'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#ApartmentsMbale<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='ApartmentsMbale<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Apartments' AND region='Mbarara'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#ApartmentsMbra<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='ApartmentsMbra<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Apartments' AND region='Gulu'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#ApartmentsGulu<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='ApartmentsGulu<?php echo $counter; ?>' style="display:none">
...
<?php
$sql = "SELECT * from add_business WHERE category='Apartments' AND region='Rest of Uganda'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#ApartmentsOthers<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='ApartmentsOthers<?php echo $counter; ?>' style="display:none">
