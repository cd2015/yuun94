...
$sql = "SELECT * from add_business WHERE category='Auditors' AND region='Kampala'";
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ...
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#AuditorsKla<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                ...
                <li class="bizDetail" id='AuditorsKla<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Auditors' AND region='Entebbe'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area" id="Ebb">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#AuditorsEbb<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='AuditorsEbb<?php echo $counter; ?>' style="display:none">
...
<!-- 
        ******** Fort portal Auditors ********
-->    

<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Auditors' AND region='Fort Portal'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#AuditorsFort<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='AuditorsFort<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Auditors' AND region='Jinja'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#AuditorsJinja<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                ...
                <li class="bizDetail" id='AuditorsJinja<?php echo $counter; ?>' style="display:none">
...
<?php
$sql = "SELECT * from add_business WHERE category='Auditors' AND region='Mbale'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#AuditorsMbale<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='AuditorsMbale<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Auditors' AND region='Mbarara'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#AuditorsMbra<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='AuditorsMbra<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Auditors' AND region='Gulu'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#AuditorsGulu<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='AuditorsGulu<?php echo $counter; ?>' style="display:none">
...
<!-- 
        ******** Rest of Uganda Auditors ********
--> 

<?php
$sql = "SELECT * from add_business WHERE category='Auditors' AND region='Rest of Uganda'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#AuditorsOthers<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='AuditorsOthers<?php echo $counter; ?>' style="display:none">
