...
$sql = "SELECT * from add_business WHERE category='Night Clubs' AND region='Kampala'";
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ...
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#NightKla<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                ...
                <li class="bizDetail" id='NightKla<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Night Clubs' AND region='Entebbe'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area" id="Ebb">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#NightEbb<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='NightEbb<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Night Clubs' AND region='Fort Portal'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#NightFort<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='NightFort<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Night Clubs' AND region='Jinja'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#NightJinja<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                ...
                <li class="bizDetail" id='NightJinja<?php echo $counter; ?>' style="display:none">
...
<?php
$sql = "SELECT * from add_business WHERE category='Night Clubs' AND region='Mbale'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#NightMbale<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='NightMbale<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Night Clubs' AND region='Mbarara'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#NightMbra<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='NightMbra<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Night Clubs' AND region='Gulu'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#NightGulu<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='NightGulu<?php echo $counter; ?>' style="display:none">
...
--> 
    ...
    <?php
    $sql = "SELECT * from add_business WHERE category='Night Clubs' AND region='Rest of Uganda'";
    $query = mysqli_query($conn, $sql);
    ...
    <h3 class="areaName">Rest of Uganda(<?php echo $count; ?>)</h3>
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#NightOther<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='NightOther<?php echo $counter; ?>' style="display:none">
