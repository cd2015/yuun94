...
<!--[if gt IE 8]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Yuunga | Entertainment </title>
                ...
                <article>
                    <div id="pageTitle">
                        <div id="pageTitleIcon">
                            <i class="fa fa-beer" id="locIcon"></i>
                        </div>
                        <div id="title">
                            <h1 id="Tit">Entertainment</h1>
                        </div>
                    </div>
                </article>
            </div>
            ...
            <article class="CentreSection">
                <section class="mono-mainSec">
                    <article class="monoSec1">
                        <div class="tabs">
                            <ul class="tab-links">
                                <li class="active"><a href="#tab1">Bars & Lounges</a></li>
                                <li><a href="#tab2">Casinos</a></li>
                                <li><a href="#tab3">Cinemas & Theaters</a></li>
                                <li><a href="#tab4">Night Clubs</a></li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab1" class="tab active">
                                    <div>
                                        <h2>Bars & Lounges</h2>
                                        <?php require_once './Bars&Lounges.php'; ?>
                                    </div>                                                                                   
                                </div>
                                ...
                                <div id="tab3" class="tab">
                                    <div>
                                        <h2>Cinema & Theatres</h2>
                                        <?php require_once './Cinemas&Theatres.php'; ?>
                                    </div>                                                                                   
                                </div>
                                ...
                                <div id="tab4" class="tab">
                                    <div>
                                        <h2>Night Clubs</h2>
                                        <?php require_once './NightClubs.php'; ?>
                                    </div>                                                                                   
                                </div>
