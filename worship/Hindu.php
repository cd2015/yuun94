...
$sql = "SELECT * from add_business WHERE category='Hindu' AND region='Kampala'";
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Hindu' AND region='Entebbe'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Hindu' AND region='Fort Portal'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Hindu' AND region='Jinja'";
$query = mysqli_query($conn, $sql);
...
<?php
$sql = "SELECT * from add_business WHERE category='Hindu' AND region='Mbale'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Hindu' AND region='Mbarara'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Hindu' AND region='Gulu'";
$query = mysqli_query($conn, $sql);
...
--> 
    ...
    <?php
    $sql = "SELECT * from add_business WHERE category='Hindu' AND region='Rest of Uganda'";
    $query = mysqli_query($conn, $sql);
