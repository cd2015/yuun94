...
$sql = "SELECT * from add_business WHERE category='Swimming/Boats/Water Sports' AND region='Kampala'";
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Swimming/Boats/Water Sports' AND region='Entebbe'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Swimming/Boats/Water Sports' AND region='Fort Portal'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Swimming/Boats/Water Sports' AND region='Jinja'";
$query = mysqli_query($conn, $sql);
...
<?php
$sql = "SELECT * from add_business WHERE category='Swimming/Boats/Water Sports' AND region='Mbale'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Swimming/Boats/Water Sports' AND region='Mbarara'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Swimming/Boats/Water Sports' AND region='Gulu'";
$query = mysqli_query($conn, $sql);
...
--> 
    ...
    <?php
    $sql = "SELECT * from add_business WHERE category='Swimming/Boats/Water Sports' AND region='Rest of Uganda'";
    $query = mysqli_query($conn, $sql);
