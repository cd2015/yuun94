...
$sql = "SELECT * from add_business WHERE category='Boxing/Kick Boxing/Martial Arts' AND region='Kampala'";
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Boxing/Kick Boxing/Martial Arts' AND region='Entebbe'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Boxing/Kick Boxing/Martial Arts' AND region='Fort Portal'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Boxing/Kick Boxing/Martial Arts' AND region='Jinja'";
$query = mysqli_query($conn, $sql);
...
<?php
$sql = "SELECT * from add_business WHERE category='Boxing/Kick Boxing/Martial Arts' AND region='Mbale'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Boxing/Kick Boxing/Martial Arts' AND region='Mbarara'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Boxing/Kick Boxing/Martial Arts' AND region='Gulu'";
$query = mysqli_query($conn, $sql);
...
--> 
    ...
    <?php
    $sql = "SELECT * from add_business WHERE category='Boxing/Kick Boxing/Martial Arts' AND region='Rest of Uganda'";
    $query = mysqli_query($conn, $sql);
