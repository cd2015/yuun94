                ...
                <article>
                    <div id="pageTitle">
                        <div id="pageTitleIcon">
                            <i class="fa fa-ambulance" id="locIcon"></i>
                        </div>
                        <div id="title">
                            <h1 id="Tit">Health</h1>
                        </div>
            ...
            <article class="CentreSection">
                <section class="mono-mainSec">
                    <article class="monoSec1">
                        <div class="tabs">
                            <ul class="tab-links">
                                <li class="active"><a href="#tab1">Hospitals</a></li>
                                <li><a href="#tab2">Clinics</a></li>
                                <li><a href="#tab3">Ambulances</a></li>
                                <li><a href="#tab4">Health Specialists</a></li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab1" class="tab active">
                                    <div>
                                        <h2>Hospitals</h2>
                                        <?php require_once './Hospitals.php'; ?>
                                    </div>                                                                                   
                                </div>
                                ...
                                <div id="tab3" class="tab">
                                    <div>
                                        <h2>Ambulances</h2>
                                        <?php require_once './Ambulances.php'; ?>
                                    </div>                                                                                   
                                </div>
                                ...
                                <div id="tab4" class="tab">
                                    <div>
                                        <h2>Health Specialists</h2>
                                        <?php require_once './HealthSpecialists.php'; ?>
                                    </div>                                                                                   
                                </div>
