...
$sql = "SELECT * from add_business WHERE category='Stationery/Stationeries' AND region='Kampala'";
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ...
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#StationeryKla<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                ...
                <li class="bizDetail" id='StationeryKla<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Stationery/Stationeries' AND region='Entebbe'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area" id="Ebb">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#StationeryEbb<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='StationeryEbb<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Stationery/Stationeries' AND region='Fort Portal'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#StationeryFort<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='StationeryFort<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Stationery/Stationeries' AND region='Jinja'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#StationeryJinja<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                ...
                <li class="bizDetail" id='StationeryJinja<?php echo $counter; ?>' style="display:none">
...
<?php
$sql = "SELECT * from add_business WHERE category='Stationery/Stationeries' AND region='Mbale'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#StationeryMbale<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='StationeryMbale<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Stationery/Stationeries' AND region='Mbarara'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#StationeryMbra<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='StationeryMbra<?php echo $counter; ?>' style="display:none">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from add_business WHERE category='Stationery/Stationeries' AND region='Gulu'";
$query = mysqli_query($conn, $sql);
    ...
    <ul class="area">
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#StationeryGulu<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='StationeryGulu<?php echo $counter; ?>' style="display:none">
...
--> 
    ...
    <?php
    $sql = "SELECT * from add_business WHERE category='Stationery/Stationeries' AND region='Rest of Uganda'";
    $query = mysqli_query($conn, $sql);
    ...
    <h3 class="areaName">Rest of Uganda(<?php echo $count; ?>)</h3>
        ...
        <ul class="BusinessList">
            ...
            while ($result = mysqli_fetch_assoc($query)) {
                ?>       
                <li class="bizThumb" id='bizThumb<?php echo $counter; ?>'>
                    <a href='#StationeryOther<?php echo $counter; ?>' class="bizzThumb">
                        <div class="thumbImg">
                            <img width="100%" src ="../images/uploads/<?php echo 'thumb_' . $result['logo']; ?>"/>
                        </div>
                        <div class="thumbDesc">
                ...
                <li class="bizDetail" id='StationeryOther<?php echo $counter; ?>' style="display:none">
