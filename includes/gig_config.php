...
<!--[if gt IE 8]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <body>
        <?php if ((login_check($mysqli) || ($_SESSION['FBID'])) == true) :
            require_once'../includes/headerLoggedinGig.php';
        ?>
            ...
            <article class="CentreSection">
                <section class="mono-mainSec">
                    <article class="monoSec1">
                        ...
                        <div class="tabs">
                            <ul class="tab-links">
                                <li class="active"><a href="#tab1">Add a Gig</a></li>
                                <li><a href="#tab2">View Your Gigs</a></li>
                            ...
                            <div class="tab-content">
                                <div id="tab1" class="tab active">
                                    <?php
                                        require_once (dirname(__FILE__).'/add_gig.php');
                                    ?>
                                </div>
                                <div id="tab2" class="tab">
                                    <?php
                                        require_once (dirname(__FILE__).'/view_gig.php');
                                    ?>
                                </div>
