...
<!--[if gt IE 8]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Yuunga Gigs | Business </title>
            ...
            <article class="CentreSection">
                <section class="mono-mainSec">
                    <article class="monoSec1">
                        <div class="tabs">
                            <ul class="tab-links">
                                <li class="active"><a href="#tab1">Business Planning</a></li>
                                <li><a href="#tab2">Career Advice</a></li>
                                <li><a href="#tab3">Market Research</a></li>
                                <li><a href="#tab4">Presentations</a></li>
                                <li><a href="#tab5">Virtual Assistant</a></li>
                                <li><a href="#tab6">Business Tips</a></li>
                                <li><a href="#tab7">Branding Services</a></li>
                                <li><a href="#tab8">Financial Consulting</a></li>
                                <li><a href="#tab9">Legal Consulting</a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab1" class="tab active">
                                    <div>
                                        ...
                                        <?php
                                        require_once "business_planning.php";
                                        ?>
                                ...
                                <div id="tab2" class="tab">
                                    <div>
                                        ...
                                        <?php
                                        require_once "career_advice.php";
                                        ?>
                                ...
                                <div id="tab3" class="tab">
                                    <div>
                                        ...
                                        <?php
                                        require_once "market_research.php";
                                        ?>
                                ...
                                <div id="tab5" class="tab">
                                    <div>
                                        ...
                                        <?php
                                        require_once "virtual_assistant.php";
                                        ?>
                                ...
                                <div id="tab6" class="tab">
                                    <div>
                                        ...
                                        <?php
                                        require_once "business_tips.php";
                                        ?>
                                ...
                                <div id="tab7" class="tab">
                                    <div>
                                        ...
                                        <?php
                                        require_once "branding_services.php";
                                        ?>
                                ...
                                <div id="tab8" class="tab">
                                    <div>
                                        ...
                                        <?php
                                        require_once "financial_consulting.php";
                                        ?>
                                ...
                                <div id="tab9" class="tab">
                                    <div>
                                        ...
                                        <?php
                                        require_once "legal_consulting.php";
                                        ?>
