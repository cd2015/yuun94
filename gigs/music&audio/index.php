...
<!--[if gt IE 8]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Yuunga Gigs | Music & Audio </title>
                ...
                <article>
                    <div id="pageTitle">
                        <div id="pageTitleIcon">
                            <i class="fa fa-music" id="locIcon"></i>
                        </div>
                        <div id="title">
                            <h1 id="Tit">Music & Audio</h1>
                        </div>
                    </div>
                </article>
                <article>
            ...
            <article class="CentreSection">
                <section class="mono-mainSec">
                    <article class="monoSec1">
                        <div class="tabs">
                            <ul class="tab-links">
                                <li class="active"><a href="#tab1">Mixing & Mastering</a></li>
                                <li><a href="#tab2">Voice Overs</a></li>
                                <li><a href="#tab3">Sound Effects</a></li>
                                <li><a href="#tab4">Session Musicians</a></li>
                                <li><a href="#tab5">Singers & Song Writers</a></li>
                                <li><a href="#tab6">Producers & Composers</a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab1" class="tab active">
                                    <div>
                                        ...
                                        <?php
                                        require_once "mixing&mastering.php";
                                        ?>
                                ...
                                <div id="tab3" class="tab">
                                    <div>
                                        ...
                                        <?php
                                        require_once "sound_effects.php";
                                        ?>
                                ...
                                <div id="tab4" class="tab">
                                    <div>
                                        ...
                                        <?php
                                        require_once "session_muscians.php";
                                        ?>
                                ...
                                <div id="tab5" class="tab">
                                    <div>
                                        <h2>Singers & Song Writers</h2>
                                    </div>
 
                                        <?php
                                        require_once "singers&songwriters.php";
                                        ?>
                                ...
                                <div id="tab6" class="tab">
                                    <div>
                                        <h2>Producers & Composers</h2>
                                    </div>

                                        <?php
                                        require_once "producers&composers.php";
                                        ?>
