...
<!--[if gt IE 8]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Yuunga Gigs | Agriculture </title>
            ...
            <article class="CentreSection">
                <section class="mono-mainSec">
                    <article class="monoSec1">
                        <div class="tabs">
                            <ul class="tab-links">
                                <li class="active"><a href="#tab1">Farmers</a></li>
                                <li><a href="#tab2">Produce Buyers</a></li>
                                <li><a href="#tab3">Market Vendors</a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab2" class="tab">
                                    <div>
                                        <h2>Produce Buyers</h2>
                                    </div>

                                        <?php
                                        require_once "produce_buyers.php";
                                        ?>
                                ...
                                <div id="tab3" class="tab">
                                    <div>
                                        ...
                                        <?php
                                        require_once "market_vendors.php";
                                        ?>
