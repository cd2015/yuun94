...
$sql = "SELECT * from gigs WHERE sub_category='Banners & Social Media Designs' AND region='Kampala'";
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Banners & Social Media Designs' AND region='Entebbe'";
$query = mysqli_query($conn, $sql);
$count = mysqli_num_rows($query);
if ($count == 0) {
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Banners & Social Media Designs' AND region='Fort Portal'";
$query = mysqli_query($conn, $sql);
$count = mysqli_num_rows($query);
if ($count == 0) {
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Banners & Social Media Designs' AND region='Jinja'";
$query = mysqli_query($conn, $sql);
...
<?php
$sql = "SELECT * from gigs WHERE sub_category='Banners & Social Media Designs' AND region='Mbale'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Banners & Social Media Designs' AND region='Mbarara'";
$query = mysqli_query($conn, $sql);
