...
$sql = "SELECT * from gigs WHERE sub_category='Business, Invitation Cards & Stationary' AND region='Kampala'";
    ...
    <ul class="area" id="Ebb">
        ...
        <ul class="BusinessList">
            ...
            <li class="bizDetail" id='bizDetail<?php echo $counter;?>' style="display:none">
                ...
                <div id="days2go">
                    <a style="color:#fff" class="update" href="../yuungagig.php?id=<?php echo $result['id']; ?>?gig=<?php echo $result['gig']; ?>">View Full Page for Gallery & Directions</a>
                </div>
                <div class="thumbImg">
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Business, Invitation Cards & Stationary' AND region='Entebbe'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Business, Invitation Cards & Stationary' AND region='Fort Portal'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Business, Invitation Cards & Stationary' AND region='Jinja'";
$query = mysqli_query($conn, $sql);
...
<?php
$sql = "SELECT * from gigs WHERE sub_category='Business, Invitation Cards & Stationary' AND region='Mbale'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Business, Invitation Cards & Stationary' AND region='Mbarara'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Business, Invitation Cards & Stationary' AND region='Gulu'";
$query = mysqli_query($conn, $sql);
...
<?php
$sql = "SELECT * from gigs WHERE sub_category='Business, Invitation Cards & Stationary' AND region='Rest of Uganda'";
$query = mysqli_query($conn, $sql);
