...
<!--[if gt IE 8]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Yuunga Gigs | Art & Gifts </title>
                ...
                <article>
                    <div id="pageTitle">
                        <div id="pageTitleIcon">
                            <i class="fa fa-shopping-bag" id="locIcon"></i>
                        </div>
                        <div id="title">
                            <h1 id="Tit">Art & Gifts</h1>
                        </div>
                    </div>
                </article>
                <article>
            ...
            <article class="CentreSection">
                <section class="mono-mainSec">
                    <article class="monoSec1">
                        <div class="tabs">
                            <ul class="tab-links">
                                <li class="active"><a href="#tab1">Art & Crafts</a></li>
                                <li><a href="#tab2">Greetings Cards</a></li>
                                <li><a href="#tab3">Hand made Jewellery</a></li>
                                <li><a href="#tab4">Gifts</a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab2" class="tab">
                                    <div>
                                        ...
                                        <?php
                                        require_once "greeting_cards.php";
                                        ?>
                                ...
                                <div id="tab3" class="tab">
                                    <div>
                                        ...
                                        <?php
                                        require_once "handmade_jewellery.php";
                                        ?>
