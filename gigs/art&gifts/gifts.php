...
$sql = "SELECT * from gigs WHERE sub_category='Gifts' AND region='Kampala'";
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Gifts' AND region='Entebbe'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Gifts' AND region='Fort Portal'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Gifts' AND region='Jinja'";
$query = mysqli_query($conn, $sql);
...
<?php
$sql = "SELECT * from gigs WHERE sub_category='Gifts' AND region='Mbale'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Gifts' AND region='Mbarara'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Gifts' AND region='Gulu'";
$query = mysqli_query($conn, $sql);
...
<?php
$sql = "SELECT * from gigs WHERE sub_category='Gifts' AND region='Rest of Uganda'";
$query = mysqli_query($conn, $sql);
