...
$sql = "SELECT * from gigs WHERE sub_category='Art & Crafts' AND region='Kampala'";
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Art & Crafts' AND region='Entebbe'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Art & Crafts' AND region='Fort Portal'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Art & Crafts' AND region='Jinja'";
$query = mysqli_query($conn, $sql);
...
<?php
$sql = "SELECT * from gigs WHERE sub_category='Art & Crafts' AND region='Mbale'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Art & Crafts' AND region='Mbarara'";
$query = mysqli_query($conn, $sql);
...
<?php
//Query that requests for all categories from ther table
$sql = "SELECT * from gigs WHERE sub_category='Art & Crafts' AND region='Gulu'";
$query = mysqli_query($conn, $sql);
...
<?php
$sql = "SELECT * from gigs WHERE sub_category='Art & Crafts' AND region='Rest of Uganda'";
$query = mysqli_query($conn, $sql);
